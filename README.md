...
| `view_annotation_overlap` | An annotation's label text overlaps a view shape bbox (full bbox for annotations without a label; centrelines, witness lines, leader shafts, datum triangles, and finish marks may touch the view freely) |
